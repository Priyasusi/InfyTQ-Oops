'''Freight Pvt. Ltd, a cargo company, forwards cargos/freights between
its customers. 
...
All validate methods should return true, if validation succeeds.
Else it should return false
validate_customer_id(): Customer id should be 6 digits and should begin
                        with digit 1
validate_weight(): Weight should be a multiple of 5
validate_distance(): Distance should be between 500kms
                    and 5000kms (both inclusive)
forward_cargo():
...
class Freight:
    ...
    def forward_cargo(self):
        if(self.__recipient_customer.validate_customer_id() and self.__from_customer.validate_customer_id()
...
c1=Customer("100001","Priya","Pollachi")
f1=Freight("100","200",60,690)
